...
type
  ...
  begin
    writeln('');
    writeln('');
    writeln('MDX_Tool_4OP 1.8 - tool for various manipulation of TX81z VMEM and VCED SysEx files');
    ...
    writeln('       -r               --repair             Repair/extract TX81z VMEM data from files');
    writeln('                                               Adds _TX81z_repaired in the file name');
    writeln('                                               Adds _x_TX81z_repaired in the file name,');
