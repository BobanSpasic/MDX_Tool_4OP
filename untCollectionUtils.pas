 ...
 *****************************************************************************
 ...
 Unit description:
 Methods to manage collection of 4OP banks and voices
...
var
  ...
  fOutput: string;
  i, j: integer;
  fDXBank: T4OPBankContainer;
  fDXVoice: T4OPVoiceContainer;
...
begin
  ...
  begin
    ...
    begin
      iStart := 0;
      iDmp := 0;
      if Contains4OPBankDump(msFileStream, iStart, iDmp) then
      begin
        fDXBank := T4OPBankContainer.Create;
